...
def save_episodes_helper(args, model_name, output_filename, write_lock=None):
...
def main():
    ...
    #     pool.apply_async(save_episodes_helper, args=(args, model_name, output_filename, write_lock))
